        ...
        init: function(options){
            ...
            return this.each(function(){
                ...
                var prepareCalendar = function(){
                    ...
                    //Убараем стрелки перелистывания, т.к. в макете они нам не нужны
                    ...
                    var nowDate = new Date(),
                        ...
                        monthName = timeForWork.month(nowMonth).format("MMMM"),
                        yearVal = parseInt(timeNowLocal.format("YYYY"));

                    monthName = monthName.charAt(0).toUpperCase() + monthName.substr(1, monthName.length-1);

                    //Меняем формат вывода даты и месяца
                    html += '<div class="ic__month-year">' + monthName + " " + yearVal + '</div>';

                    //Убираем стандартный вывод месяца с возможностью его смены
                    ...
                    // head year
                    //Убираем стандартный вывод года с возможностью его смены
